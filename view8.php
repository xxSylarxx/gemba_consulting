...
<head>
    ...
    <link rel="stylesheet" href="./portadas-blog/pblog<?php echo $_GET['id']; ?>.css">
    <!-- carrousel -->
...
<body>
    ...
    <section id="contenido" class="pt-5">
        <div class="container-fluid d-flex justify-content-center" style="padding-left: 7%;padding-right: 7%;">
            <div class="row d-flex justify-content-center">
                <div class="col-lg-8 pt-5">
                    <?php include_once './blog/blog' . $_GET['id'] . '.php';
                    ?>


                    <!--  <div class="row d-flex justify-content-center p-4" style="background-color: var(--color11);">
                        <div class="col-lg-2">
                            <div class="avatar">
                                <img src="./public/img/galeria/autor.jpg" alt="Author">
                            </div>
                        </div>
                        <div class="col-lg-5 my-auto">
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Assumenda iusto sequi ab enim? Eligendi voluptatibus fugiat ea atque ratione illum fugit laboriosam corrupti! Libero dicta, culpa omnis magnam aspernatur dolorem.</p>
                        </div>
                    </div> -->
                    <div class="row d-flex justify-content-center pt-5">
                        <div class="col-lg-4 d-flex justify-content-center">
                            <button class="btn-outline" onclick="window.location.href='./blog.php'">Regresar</button>
                        </div>
                    </div>
                </div>
    ...
    <?php include_once './blog-contacto-seccion.php'; ?>
