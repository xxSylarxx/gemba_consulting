...
<head>
    ...
    <link rel="stylesheet" href="./portadas-certificacion/pcertificacion<?php echo $_GET['id']; ?>.css">
    <!-- carrousel -->
...
<body>
            ...
            <div class="col-lg-9 text-center">
                ...
                <h1 class="mb-4" style="letter-spacing: 1px;">
                    <p style="text-align: center;" class="pt-3">
                        ...
                        switch ($_GET['id']) {
                            case 1:
                                echo "Certificación Six Sigma Green Belt";
                                break;
                            case 2:
                                echo "Certificación Six Sigma Black Belt";
                                break;
                            default:
                                echo "Bienvenido a Certificaciones";
                                break;
                        }
                        ?>
                    </p>
    ...
    <section id="contenido">
        <div class="container-fluid d-flex justify-content-center" style="padding-left: 7%;padding-right: 7%;">
            <div class="row d-flex justify-content-center">
                <div class="col-lg-8">
                    <?php include_once './certificaciones/certificacion' . $_GET['id'] . '.php';
                    ?>
                    <br>
                    <div class="row d-flex justify-content-center pt-5">
                        <div class="col-lg-4 d-flex justify-content-center">
                            <button class="btn-outline" onclick="window.location.href='./certificacion.php'">Regresar</button>
                        </div>
                    </div>
                </div>
