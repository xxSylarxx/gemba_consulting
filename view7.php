...
<head>
    ...
    <link rel="stylesheet" href="./portadas-minerias/pmineria<?php echo $_GET['id']; ?>.css">
    <!-- carrousel -->
        ...
        <div class="container-fluid d-flex justify-content-center" style="padding-left: 7%;padding-right: 7%;">
            <div class="row d-flex justify-content-center">
                <div class="col-lg-8 pt-4">
                    <?php include_once './minerias/mineria' . $_GET['id'] . '.php';
                    ?>
                    <br>
                    <div class="row d-flex justify-content-center pt-5">
                        <div class="col-lg-4 d-flex justify-content-center">
                            <button class="btn-outline" onclick="window.location.href='./mineria.php'">Regresar</button>
                        </div>
                    </div>
                </div>
