...
<body>
    ...
    <style>
        #cuerpo {
            background-image: url('./public/img/galeria/p-alimentaria.png');
    ...
    <section id="cuerpo">
        <div class="container-fluid m-0 p-0">
            <div class="row d-flex justify-content-center m-0 p-0">
                <div class="col-lg">
                    <h1>Manufactura de Alimentos</h1>
                </div>
            </div>
        </div>
    </section>
                        ...
                        <div class="contenedor-servicios1 mx-3" style="position:relative; overflow: hidden;">
                            ...
                            <div class="back-servicios1 d-flex justify-content-center">
                                <div class="c-servicio1">
                                    ...
                                    <p>La industria de alimentos en el Perú desempeña un papel fundamental en la economía nacional, gracias a su rica biodiversidad y la creciente demanda de productos tanto en mercados locales como internacionales.</p>
                                </div>
                            </div>
                        </div>
                    </a>
