...
<body>
    ...
    <style>
        #cuerpo {
            background-image: url('./public/img/web/p-capacitacion.jpg');
                    ...
                    <a href="./view3.php?id=1">
                        <div class="contenedor-servicios1 mx-3" style="position:relative; overflow: hidden;">
                            <div class="img-contenedor-servicios1">
                                <img src="./public/img/galeria/capacitacion1.jpg" class="w-100" alt="">
                            </div>
                            ...
                            <div class="back-servicios1 d-flex justify-content-center">
                                <div class="c-servicio1">
                                    ...
                                    <p>Nuestro programa de capacitación in-house está diseñado para ayudar a las organizaciones a adoptar esta metodología de manera práctica y efectiva.</p>
                                </div>
                            </div>
                        </div>
                    </a>
