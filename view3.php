...
<head>
    ...
    <link rel="stylesheet" href="./portadas-capacitacion/pcapacitacion<?php echo $_GET['id']; ?>.css">
    <!-- carrousel -->
...
<body>
                    ...
                    <p style="text-align: center;" class="pt-3">
                        ...
                        switch ($_GET['id']) {
                            case 1:
                                ...
                                break;
                            default:
                                echo "Bienvenido a Capacitaciones";
                                break;
                        }
                        ?>
                    </p>
    ...
    <section id="contenido">
        <div class="container-fluid d-flex justify-content-center" style="padding-left: 7%;padding-right: 7%;">
            <div class="row d-flex justify-content-center">
                <div class="col-lg-8">
                    <?php include_once './capacitaciones/capacitacion' . $_GET['id'] . '.php';
                    ?>
                    <br>
